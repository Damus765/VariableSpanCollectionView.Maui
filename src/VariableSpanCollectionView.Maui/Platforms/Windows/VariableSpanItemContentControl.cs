...
namespace VariableSpanCollectionView.Maui
{
	...
	// Otherwise we'll see the error => "WinRT information: The type 'VariableSpanItemContentControl' was not found."
	// https://stackoverflow.com/a/15139410
	[Microsoft.UI.Xaml.Data.Bindable]
	public class VariableSpanItemContentControl : ItemContentControl
	{
		ItemsView _itemsView;

		public VariableSpanItemContentControl()
		{
