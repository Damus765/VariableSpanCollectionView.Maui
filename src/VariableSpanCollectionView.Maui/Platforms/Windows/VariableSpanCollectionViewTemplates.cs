...
{
	internal static class VariableSpanCollectionViewTemplates
	{
		...
		{
			var xaml =
				"<DataTemplate xmlns=\"http://schemas.microsoft.com/winfx/2006/xaml/presentation\" xmlns:local=\"using:VariableSpanCollectionView.Maui\">" +
				"<local:VariableSpanItemContentControl HorizontalContentAlignment=\"Stretch\" VerticalContentAlignment=\"Stretch\"/>" +
				"</DataTemplate>";
