...
{
	public class VariableSpanCollectionViewController<TItemsView> : GroupableItemsViewController<TItemsView>
		where TItemsView : VariableSpanCollectionView
	{
		bool _disposed;
		UILongPressGestureRecognizer _longPressGestureRecognizer;

		public VariableSpanCollectionViewController(TItemsView groupableItemsView, ItemsViewLayout layout)
